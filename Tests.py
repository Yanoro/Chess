...
@pytest.mark.parametrize("Position, Movement, CheckAnswer, CheckMateAnswer", [(Position1, ["G1", "G8"], True, False), (Position2, ["G1", "G8"], True, True), (Position3, ["E2", "E4"], False, False), (Position4, ["A6", "A8"], True, True), (Position5, ["A1", "A6"], False, False), (Position6, ["D3", "B5"], True, False), (Position7, ["E6", "E7"], False, False), (TowerCheckMate, ["A3", "A8"], True, True), (LastTest2, ["A4", "B5"], True, False)])
...
def test_Movement(TestedPiece, Tests):
    ...
    for Move in CorrectMoves:
        TilePath = CreateTilePath(TestedPiece, Move)
